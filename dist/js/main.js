...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var _loop3 = function _loop3(_index) {
    var checkboxCategory = checkboxCategories[_index];
    checkboxCategory.addEventListener('change', function () {
      ...
      if (checkboxActiveCategories.length > 0) {
        ...
        var searchQuantity = pageSelect.querySelector('.search-page__quantity');
  ...
  for (var _index = 0; _index < checkboxCategories.length; _index++) {
    _loop3(_index);
  } //SlideToggle
